        ...
        <Modal visibility={visible} closeModal={closeModal}>
            <AppForm
                ...
                <div className='flex justify-between w-full'>
                    <p className='text-black dark:text-white text-xl font-medium  leading-[30px]'>{val ? t(messages.UPDATE) : t(messages.ADD_REPRESENTATIVE)}</p>
                ...
                <div className='self-end flex gap-3'>
                    <SubmitButton loading={loading} title={val ? t(messages.UPDATE) : t(messages.ADD_REPRESENTATIVE)} className="self-end bg-primaryBlue" />
