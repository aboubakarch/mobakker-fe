        ...
        <Modal visibility={visible} closeModal={closeModal} className='md:w-[35%]'>
            <div className='p-10 flex flex-col gap-5'>
                <div className='flex flex-col gap-3 items-center'>
                    ...
                    <h1 className="text-center text-gray-900 dark:text-white text-xl font-semibold  leading-[30px]">{t(messages.ARE_YOU_SURE)}</h1>
                    <div className=" text-center">
                        <span className="text-gray-500 dark:text-white text-base font-normal leading-normal">{t(messages.DELETE_CONFIRMATION)} </span>
                        <span className="text-black dark:text-white text-base font-bold font-['Inter'] leading-normal">{t(title)}</span>
                    </div>

                </div>
                <div className='flex gap-4 items-center justify-center'>

                    <Button onClick={closeModal} className='bg-background text-black dark:text-white hover:bg-indigo-800 hover:bg-opacity-5 border border-zinc-200'>{t(messages.CANCEL)}</Button>
