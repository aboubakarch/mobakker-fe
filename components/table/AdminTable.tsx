...
import { adminColumns } from './columns/AdminColumn'

const AdminTable: FC<ITableProps<SampleProvider>> = ({ handleEdit, handleDelete, handleRow, onUpdateFlag }) => {
    ...
    return (
        ...
        <div>
            {!pageLoaded && data.length === 0 ? (
                ...
                data={data}
                columns={adminColumns(t, handleEdit, handleDelete)}
