...
export const employeeRatingColumns: (
    t: TFunction<"translation", undefined>,
    handleEdit?: (val: SampleEmployeeRating) => void,
    handleDelete?: (val: SampleEmployeeRating) => void,
            ...
            return (
                <div className="flex gap-3 items-center justify-center w-max">
                    <div className="rounded-full h-11 w-11 relative">
                        <Image
                            src={employee.user.avatar && isValidImageSrc(employee.user.avatar) ? employee.user.avatar : '/assets/sampleImage.jpg'}
                            alt="employee avatar"
                            fill
