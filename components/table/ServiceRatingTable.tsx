...
import { serviceRatingColumns } from './columns/ServiceRatingColumn';
// import ServiceRatingFilters from './filters/ServiceRatingFilters';

const ServiceRatingTable: FC<ITableProps<SampleServiceRating>> = ({
    handleEdit, handleDelete, onUpdateFlag, handleRow
}) => {
    const { t } = useTranslation();
    const { toast } = useToast();
    const [data, setData] = useState<SampleServiceRating[]>([]);
    ...
    // const [filters, setFilters] = useState<IServiceRatingFilters>({});
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await APIService.getInstance().getServiceRatings(params);
    ...
    // const handleApplyFilters = (fil: IServiceRatingFilters) => {
    //     setFilters(fil);
    // };
...
export default ServiceRatingTable;
