...
const Ratings = () => {
    const [selectedTab, setSelectedTab] = useState<'branch' | 'service' | 'employee' | 'customer'>('branch');
        ...
        <div className="flex flex-col gap-4 h-full w-full p-5 pb-0 overflow-auto scrollbar">
            ...
            <Tabs value={selectedTab} onValueChange={(value) => setSelectedTab(value as any)} className="w-full">
                ...
                <TabsContent value="branch">
                    <BranchRatingTable handleEdit={handleEdit} handleDelete={handleDelete} onUpdateFlag={flag} handleRow={handleRow} />
                </TabsContent>
