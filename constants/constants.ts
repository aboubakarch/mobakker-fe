...
export const messages = {
  ...
  TOTAL_APPOINTMENTS: "common:totalAppointments",
  TOTAL_CANCELED: "common:totalCanceled",
  TOTAL_COMPLETED: "common:totalCompleted",
  TOTAL_PENDING: "common:totalPending",
  TOTAL_SERVICES: "common:totalServices",
  TOTAL_EMPLOYEES: "common:totalEmployees",
  TOTAL_LOYAL_PROGRAMS: "common:totalLoyalPrograms",
  TOTAL_PROMOTIONS: "common:totalPromotions",
  FILTER: "common:filter",
  SORT: "common:sort",
  ROWS_PER_PAGE: "common:rowsPerPage",
  Day: "common:day",
  Month: "common:month",
  Year: "common:year",
  ...
  OWNER_NAME: "common:ownerName",
  SERVICES_COUNT: "common:servicesCount",
  APPOINTMENTS_COUNT: "common:appointmentsCount",
  BOOKING_SLOT: "common:slot",
  BOOKING_DATE: "common:date",
  REPEAT: "common:repeat",
  GROSS_TOTAL: "common:grossTotal",
  DISCOUNT: "common:discount",
  NET_TOTAL: "common:netTotal",
  PAYMENT_STATUS: "common:status",
  PAYMENT_TYPE: "common:type",
  STATUS: "common:status",
  CUSTOMER_NAME: "common:customerName",
  EMPLOYEE_NAME: "common:employeeName",
  EMAIL: "common:email",
  PHONE: "common:phone",
  ACTIVE_STATUS: "common:activeStatus",
  ...
  WORK_HOUR_FROM: "schedule:workHourFrom",
  SLOT_TIME: "schedule:slotTime",
  WORK_HOUR_TO: "schedule:workHourTo",
  DESCRIPTION: "common:description",
  TYPE: "common:type",
  END_DATE: "common:endDate",
  START_DATE: "common:startDate",
  REVIEWER: "common:reviewer",
  AVERAGE_RATING: "common:averageRating",
  REVIEW: "common:review",
  MANAGE_DESCRIPTION: "common:manageDescription",
  FILTERS: "common:filters",
  FILTER_DESCRIPTION: "common:filterDescription",
  RESET_FILTER: "common:resetFilter",

  ADMIN: "common:admin",
  MOST_ACTIVE_SERVICE: "common:mostActiveService",
  MOST_ACTIVE_CITY: "common:mostActiveCity",
  MOST_ACTIVE_PROVIDER: "common:mostActiveProvider",
  MOST_ACTIVE_CATEGORY: "common:mostActiveCategory",
  PENDING: "common:pending",
  REJECTED: "common:rejected",
  MONTHLY_PERFORMANCE: "common:monthlyPerformance",
  ADMINS: "common:admins",
  TRANSACTION_ID: "common:transactionId",
  INITIATED_BY: "common:initiatedBy",
